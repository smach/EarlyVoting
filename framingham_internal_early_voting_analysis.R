...
# Zip code 01701: 12.7 + 3.9 + 6.5 + 14.8 + 11 + 2.1 = 51% at commutes of half an hour or more. 27.9% 45 minutes or more.
# Zip code 01702: 16.2 + 3.2 + 4.9 + 8.2 + 8.8 + 2.1 = 43.4% with commutes of half an hour or more.
